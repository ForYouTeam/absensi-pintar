          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2 text-secondary">
                  <span class="app-brand-text demo menu-text fw-bolder"> <img src="{{asset('assets/img/absensi.png')}}" style="width: 3rem; margin-right: -0.8rem" alt=""> 
                    absen pintar
                  </span>
                </a>
              </div>
