...
@section('content')
                        ...
                        <tbody>
                          ...
                          @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td style="width: 50%">{{ $item['start'] }}</td>
                                    <td>{{$item['end']}}</td>
                                    <td>{{$item['tipe']}}</td>
                                    <td>
    ...
    <script>
        ...
        $('body').on('click', '.editItem', function () {
            ...
            $.get("http://127.0.0.1:8000/api/v1/ketentuan/" + _id, function (res) {
        ...
        $('#btn-simpan').click(function (e) {
            ...
            if(!submitButton){
                ...
                $.ajax({
                    ...
                    url: "http://127.0.0.1:8000/api/v1/ketentuan",
                    type: "POST",
                    dataType: 'json',
        ...
        $(document).on('click', '#btn-hapus', function() {
            ...
            let url = "http://127.0.0.1:8000/api/v1/ketentuan/" + _id;
            Swal.fire({
                title: 'Anda Yakin?',
